                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Main Category Table :</h6>
                        </div>
                        <div class="col-lg-4 card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <a href="./main_category_add.php">
                                <h6 class="m-0 font-weight-bold text-success">Add Another Main Category</h6>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="table-responsive table-bordered text-center text-dark e1">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">Id</th>
                                <th scope="col">Main_Category Name</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td><a href="main_category_update.php?id=<?php echo $rows['id'] ?>">
                                            <script src="https://cdn.lordicon.com/lordicon.js"></script>
                                            <lord-icon src="https://cdn.lordicon.com/qzlhsleu.json" trigger="hover" style="width:30px;height:30px">
                                            </lord-icon>
                                            <a href="main_category_delete.php?id=<?php echo $rows['id'] ?>">
                                                <script src="https://cdn.lordicon.com/lordicon.js"></script>
