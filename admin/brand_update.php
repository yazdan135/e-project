...
<div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="card-body">
        <form method="post">
          <div class="form-group">
            ...
            <input type="text" name="brand" value="<?php echo $rows['brand_name'] ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Brand">
  ...
  if (isset($_POST['update'])) {
    ...
    $sql = "update brand set brand_name  = '$brand' where id = $Id";
    $result = mysqli_query($con, $sql);
