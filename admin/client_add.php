    ...
    <div class="card mb-4 mx-auto col-lg-8">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <a href="./client_show.php">
              <h6 class="m-0 font-weight-bold text-success">See Client Table</h6>
            </a>
          </div>
        </div>
      </div>
      <form action="" method="post">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="addrest" class="form-control" id="inputEmail3">
          </div>
        </div>
        ...
        <button type="submit" name="submit" class="btn btn-primary mb-3">Add Client</button>
      </form>
    </div>
...
if (isset($_POST['submit'])) {
  ...
  $sql = "insert into client (role_id_FK , name , email , password , address , contact , dob) values ('$role_id' , '$username' , '$email' , '$password' , '$address' , '$contact' , '$dob')";
  $result = mysqli_query($con, $sql);
