...
<div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="card-body">
        <form method="post">
          <div class="form-group">
            <label for="exampleInputEmail1">Main_Category :</label>
            <input type="text" name="main" value="<?php echo $rows['main_category_name'] ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Brand">

          </div>


          <button type="submit" name="update" class="btn btn-primary">Update Main Category</button>
        </form>
      </div>
    </div>
  </div>
  ...
  if (isset($_POST['update'])) {
    ...
    $sql = "update main_category set main_category_name  = '$main' where id = $Id";
    $result = mysqli_query($con, $sql);

    echo "<script>
    alert('Main_Category Updated Successfully');
