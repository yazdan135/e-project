                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <a href="./brand_add.php">
                                <h6 class="m-0 font-weight-bold text-success">Add Another Brand</h6>
                            </a>
                        </div>
                    </div>
                </div>
