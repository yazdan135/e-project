...
include("./header.php");
$sql = "select user .* ,  role.role_name from user inner join role on role.id = user.role_id_FK";
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <a href="./user_add.php">
              <h6 class="m-0 font-weight-bold text-success">Add Another User</h6>
            </a>
          </div>
        </div>
      </div>
