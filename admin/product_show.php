...
include("./header.php");
$sql = "select product .* , brand.brand_name , sub_cateory.sub_category_name from product inner join brand on brand.id = product.brand_id_FK inner join sub_cateory on sub_cateory.id = product.sub_category_id_FK";
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <a href="./product_add.php">
                                <h6 class="m-0 font-weight-bold text-success">Add Another Product</h6>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td><img src="img/product/<?php echo $rows['product_image'] ?>" height="70px" width="70px"></td>
                                    <td><a href="product_update.php?id=<?php echo $rows['id'] ?>">
                                            ...
                                            <a href="product_delete.php?id=<?php echo $rows['id'] ?>">
                                                <script src="https://cdn.lordicon.com/lordicon.js"></script>
