...
<div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="form-group mt-4">
                        <label for="inputEmail3" class="col-form-label">Select Order:</label>

                        <select id="inputState" name="o_id" class="form-control">
                            <?php
                            $sql = "select * from order";
                            $result = mysqli_query($con, $sql);
                            while ($rows = mysqli_fetch_assoc($result)) {
                            ?>
                                <option value="<?php echo $rows['id'] ?>"><?php echo $rows['client_id_FK'] ?>
                                </option>;
                            <?php } ?>
                    ...
                    <div class="form-group mt-4">
                        <label for="inputEmail3" class="col-form-label">Select Product:</label>

                        <select id="inputState" name="p_id" class="form-control">
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="total" class="form-control" id="exampleInputEmail1">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "insert into `order_list` (order_id_FK	, product_id_FK, quantity, price, total) values 
        ('$order', '$product', '$quantity', '$price', '$total')";
        $result = mysqli_query($con, $sql);

        echo "<script>
    alert('Order Added Successfully');
    window.location.href='order_list_show.php'
    </script>";
    }
