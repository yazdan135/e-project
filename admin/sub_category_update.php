    ...
    <div class="card mb-4 mx-auto col-lg-8">
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="form-group mt-4">
          ...
          <label for="inputEmail3" class="col-form-label">Select Main Category :</label>

          <select id="inputState" name="m_c_id" class="form-control">
            <?php
            $sql = "select * from main_category";
            $result = mysqli_query($con, $sql);
            while ($rows = mysqli_fetch_assoc($result)) {
            ?>
              <option value="<?php echo $rows['id'] ?>"><?php echo $rows['main_category_name'] ?>
              </option>;
            <?php } ?>
          ...
          <?php
          $Id = $_GET['id'];
          $sql = "select * from sub_cateory where id = '$Id'";
          $result = mysqli_query($con, $sql);
          $rows = mysqli_fetch_assoc($result);
          ?>
          <div class="form-group mt-3">
            <label for="inputEmail3" class="col-form-label">Sub Category Name :</label>

            <input type="text" value="<?php echo $rows['sub_category_name'] ?>" name="sub" class="form-control mb-3" id="inputEmail3">
