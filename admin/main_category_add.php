...
<div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Main Category Form :</h6>
          </div>
          <div class="col-lg-4 card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <a href="./main_category_show.php">
              <h6 class="m-0 font-weight-bold text-success">See Main Category Table</h6>
            </a>
          </div>
        </div>
      </div>
      <div class="card-body">
        <form method="post">
          <div class="form-group">
            ...
            <input type="text" name="main" class="form-control" id="exampleInputEmail1" placeholder="Enter Main Category">

          </div>


          <button type="submit" name="submit" class="btn btn-primary">Add Main Category</button>
        </form>
      </div>
    </div>
  </div>
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "insert into main_category (main_category_name) values ('$main')";
