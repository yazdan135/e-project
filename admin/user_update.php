    ...
    <div class="card mb-4 mx-auto col-lg-8">
      ...
      <form action="" method="post">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" value="<?php echo $rows['username'] ?>" name="user" class="form-control" id="inputEmail3">
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="email" value="<?php echo $rows['email'] ?>" name="email" class="form-control" id="inputEmail3">
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="password" value="<?php echo $rows['password'] ?>" name="password" class="form-control" id="inputEmail3">
          </div>
        </div>

        <button type="submit" name="update" class="btn btn-primary mb-3">Update User</button>
      </form>
    </div>
...
if (isset($_POST['update'])) {
  ...
  $sql = "update user set role_id_FK = '$role_id', username = '$username', email = '$email', password = '$password' where id = $Id";
  $result = mysqli_query($con, $sql);
